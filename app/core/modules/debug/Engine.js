...
Debug.prototype = {
    ...
    */
    ...
    drawLine: function(p1, p2, width, color) {
        ...
        this.context.strokeStyle = color || '#00FF00';
        this.context.beginPath();
        this.context.moveTo((p1.x + 0.5) - this.game.camera.x, (p1.y + 0.5) - this.game.camera.y);
        this.context.lineTo((p2.x + 0.5) - this.game.camera.x, (p2.y + 0.5) - this.game.camera.y);
        this.context.closePath();
        this.context.stroke();
        this.stop();
    },
